...
export default function DoctorPatients() {
    ...
    const fetchPatients = async () => {
        setLoading(true);
        try {
            // Doctors use the same admin endpoint which we opened up
    ...
    const handleExport = () => {
        ...
        link.setAttribute("download", `aurahealth_patients_${new Date().toISOString().split('T')[0]}.csv`);
    ...
    const sidebarItems = [
        ...
        { name: 'Patient Directory', icon: Users, href: '/doctor/patients' },
            ...
            <main className="flex-1 lg:ml-[280px] flex flex-col min-h-screen">
                ...
                <header className="h-20 bg-white border-b border-[#E8E4D9] flex items-center justify-between px-10 sticky top-0 z-20 shadow-sm">
                    <div className="flex items-center gap-6 relative">
                        <NotificationBell />
                        <div className="flex items-center gap-4 bg-[#FDFBF7] border border-[#E8E4D9] rounded-[1.2rem] px-6 py-2.5 w-full max-w-sm focus-within:border-[#2563EB] focus-within:ring-4 focus-within:ring-[#2563EB]/10 transition-all duration-300">
                    ...
                    <div className="flex items-center gap-8 pl-8 border-l border-[#E8E4D9]">
                ...
                <div className="p-10 max-w-7xl mx-auto w-full space-y-12 pb-24">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                        <div>
                            <h2 className="text-4xl font-black tracking-tight text-[#2D3436] mb-2 uppercase tracking-tight">Patient Directory</h2>
                            <p className="text-[#636E72] text-base font-medium opacity-60">Insight into clinical demographics and health indicators.</p>
                        </div>
                        <button 
                        ...
                        >
                            <Download className="w-4 h-4 text-[#2563EB] group-hover:scale-110 transition-transform" />
                            Export Data
                        </button>
                    </div>
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-10">
                        {/* Main Directory */}
                        <div className="xl:col-span-2 bg-white rounded-[3.5rem] border border-[#E8E4D9] shadow-sm overflow-hidden border-b-[10px] border-b-[#60A5FA]">
                            <div className="p-10 border-b border-[#E8E4D9]/50 flex items-center justify-between flex-wrap gap-6 bg-[#FDFBF7]/30">
                                <div className="flex items-center gap-4 bg-white border border-[#E8E4D9] rounded-[1.2rem] px-6 py-3 w-full max-w-md focus-within:border-[#2563EB] focus-within:ring-4 focus-within:ring-[#2563EB]/10 transition-all duration-300">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <button 
                                        ...
                                        className={`px-6 py-3 rounded-[1.2rem] border text-[11px] font-black uppercase tracking-widest transition-all duration-300 shadow-sm flex items-center gap-2 ${
                                            sortOrder === 'latest' ? 'bg-[#2563EB] text-white border-[#2563EB]' : 'bg-white text-[#636E72] border-[#E8E4D9] hover:bg-[#FDFBF7]'
                                        }`}
                                    >
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full text-left">
                                    <thead className="bg-[#FDFBF7]">
                                        <tr>
                                            <th className="px-10 py-6 text-[11px] font-black text-[#636E72] uppercase tracking-[0.2em] border-b border-[#E8E4D9]">Patient Profile</th>
                                            ...
                                            <tr key={p.id} className="hover:bg-[#FDFBF7]/40 transition-colors duration-300 group">
                                                <td className="px-10 py-8">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            <p className="font-black text-base tracking-tight text-[#2D3436] group-hover:text-[#2563EB] transition-colors flex items-center gap-2">
                                                                {p.name}
                                                                {p.status === 'URGENT' && (
                                                ...
                                                <td className="px-10 py-8">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <p className="text-[9px] font-black text-[#636E72] uppercase tracking-widest opacity-40">Consultations</p>
                                                    </div>
                                                </td>
                                                <td className="px-10 py-8">
                                                    <div className="flex items-center gap-3">
                                                ...
                                                <td className="px-10 py-8 text-right">
                                                    <button 
                                                        ...
                                                        className="w-10 h-10 rounded-xl bg-[#FDFBF7] border border-[#E8E4D9] flex items-center justify-center text-[#636E72] hover:text-[#2563EB] hover:border-[#2563EB]/30 transition-all duration-300 active:scale-90"
                                                    >
                        ...
                        <div className="space-y-10">
                            <div className="bg-[#2563EB] p-10 rounded-[3.5rem] text-white shadow-2xl shadow-[#2563EB]/30 relative overflow-hidden group">
                                <div className="absolute top-0 right-0 w-48 h-48 bg-white/5 rounded-full blur-3xl -mr-24 -mt-24"></div>
                                <Activity className="w-12 h-12 text-[#60A5FA] mb-8" />
                                <h4 className="text-2xl font-black mb-4 tracking-tight uppercase tracking-tighter">Clinical Summary</h4>
                                <p className="text-[#60A5FA] font-medium text-base mb-10 leading-relaxed opacity-90 italic">Reviewing global demographics to assess triage efficiency and anomaly detection.</p>
                                
                                <div className="space-y-4">
                                    <div className="flex justify-between text-[11px] font-black uppercase tracking-[0.2em] text-[#60A5FA]">
                                        <span>System Integrity</span>
                                        <span>99.9%</span>
                                    </div>
                                    <div className="w-full bg-black/20 rounded-full h-2">
                                        <div className="bg-white h-full rounded-full w-[99%]" />
                                    </div>
                                </div>
                            </div>
                        ...
                        >
                            ...
                            <div className="p-12">
                                <div className="flex items-center gap-8 mb-10">
                                    <div className="w-24 h-24 rounded-[2rem] bg-[#2563EB]/10 text-[#2563EB] flex items-center justify-center font-black text-3xl shadow-inner border border-[#2563EB]/20">
                                        {selectedPatient.name.charAt(0)}
                                    </div>
                                    <div>
                                        <h3 className="text-3xl font-black text-slate-900 tracking-tight">{selectedPatient.name}</h3>
                                        <p className="text-lg font-bold text-[#2563EB] uppercase tracking-widest">PATIENT ID #{selectedPatient.id.toString().padStart(4, '0')}</p>
                                    </div>
                                </div>
                                    ...
                                    <>
                                        ...
                                        <div className="flex gap-4">
                                            <button 
                                                ...
                                                className="flex-1 bg-[#2563EB] text-white py-4 rounded-[1.5rem] font-black uppercase tracking-widest shadow-lg shadow-[#2563EB]/20 hover:scale-[1.02] transition-all"
                                            >
                                        ...
                                        <div className="space-y-6 max-h-[400px] overflow-y-auto pr-4 custom-scrollbar">
                                            {timeline.length > 0 ? timeline.map((event, idx) => (
                                                <div key={event.id} className="relative pl-8 pb-6 border-l-2 border-slate-100 last:border-0">
                                                    <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-white border-4 border-[#2563EB]" />
                                                    <div className="bg-slate-50 rounded-[1.5rem] p-6 border border-slate-100 group hover:border-[#2563EB]/30 transition-all">
                                                        <div className="flex justify-between items-start mb-2">
                                                            <p className="font-black text-slate-900 group-hover:text-[#2563EB] transition-colors">{event.title}</p>
